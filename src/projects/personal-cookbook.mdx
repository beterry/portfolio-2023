...
madeWith: Angular
color: "#F1F1E9"
ipad: ../images/projects/cookbook/gallery.png
...
![Editing a recipe](../images/projects/cookbook/edit.png)
...
### Preparation Tab and Shopping List

Two featured which I wanted to make my life easier were a preparation tab and a shopping list
